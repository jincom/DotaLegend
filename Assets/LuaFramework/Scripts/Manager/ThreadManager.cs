    ...
    public class ThreadManager : Manager
    {
        ...
        private void OnSyncEvent(NotiData data)
        {
            ...
            (
                () =>
                {
                    ...
                    facade.SendMessageCommand(data.evName, data.evParam);
                }
            ); //通知View层
        }

        // 該函數由一個新綫程執行，在Awake聲明，Start啓動
        void OnUpdate()
        {
            while (true)
            {
        ...
        private void ProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            */
            ...
            NotiData data = new NotiData(NotiConst.UPDATE_PROGRESS, e.ProgressPercentage);
