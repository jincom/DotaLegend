...
public static class DelegateFactory
{
	...
	class SUIFW_MessageCenter_DelMessageDelivery_Event : LuaDelegate
	{
		public SUIFW_MessageCenter_DelMessageDelivery_Event(LuaFunction func) : base(func) { }
		public SUIFW_MessageCenter_DelMessageDelivery_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(SUIFW.KeyValuesUpdate param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(SUIFW.KeyValuesUpdate param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate SUIFW_MessageCenter_DelMessageDelivery(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			SUIFW.MessageCenter.DelMessageDelivery fn = delegate(SUIFW.KeyValuesUpdate param0) { };
			return fn;
		}

		if(!flag)
		{
			SUIFW_MessageCenter_DelMessageDelivery_Event target = new SUIFW_MessageCenter_DelMessageDelivery_Event(func);
			SUIFW.MessageCenter.DelMessageDelivery d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
