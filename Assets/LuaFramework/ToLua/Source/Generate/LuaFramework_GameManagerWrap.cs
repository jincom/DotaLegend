...
public class LuaFramework_GameManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("PermitUpdate", get_PermitUpdate, set_PermitUpdate);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PermitUpdate(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			bool ret = obj.PermitUpdate;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index PermitUpdate on a nil value" : e.Message);
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_PermitUpdate(IntPtr L)
	{
		object o = null;
