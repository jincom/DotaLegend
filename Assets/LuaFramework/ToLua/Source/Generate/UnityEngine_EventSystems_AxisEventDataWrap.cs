...
public class UnityEngine_EventSystems_AxisEventDataWrap
{
	...
	static int get_moveVector(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index moveVector on a nil value" : e.Message);
		}
	}
	...
	static int get_moveDir(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index moveDir on a nil value" : e.Message);
		}
	}
