...
public class UnityEngine_RectTransformWrap
{
	...
	static int DOShakeAnchorPos(IntPtr L)
	{
		try
		{
			...
			if (count == 6 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.RectTransform), typeof(float), typeof(float), typeof(int), typeof(float), typeof(bool)))
			{
			...
			else if (count == 6 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.RectTransform), typeof(float), typeof(UnityEngine.Vector2), typeof(int), typeof(float), typeof(bool)))
			{
				UnityEngine.RectTransform obj = (UnityEngine.RectTransform)ToLua.ToObject(L, 1);
				float arg0 = (float)LuaDLL.lua_tonumber(L, 2);
