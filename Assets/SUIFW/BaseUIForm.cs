...
namespace SUIFW
{
	public class BaseUIForm : View {
	    ...
	    {
            UIManager.ShowUIForms(uiFormName, true, true);
        }

        public void OpenUIForm(string uiFormName, bool isLuaForm)
        {
            UIManager.ShowUIForms(uiFormName, isLuaForm, true);
        }

        public void OpenUIForm(string uiFormName, bool isLuaForm, bool loadFromAB)
        {
            UIManager.ShowUIForms(uiFormName, isLuaForm, loadFromAB);
        }
	    ...
	    {
	        string strUIFormName = string.Empty;            //处理后的UIFrom 名称
	        //int intPosition = -1;
         ...
         //   }
            ...
            UIManager.CloseUIForms(strUIFormName);
        }

	    public void CloseUIForm(string uiFormName)
	    {
            UIManager.CloseUIForms(uiFormName);
        }
