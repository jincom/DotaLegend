...
namespace SUIFW
{
    ...
    /// UI窗体的显示类型
    /// </summary>
    public class UIFormShowMode
    {
        //普通
        public const int Normal = 0;
        //反向切换
        public const int ReverseChange = 1;
        //隐藏其他
        public const int HideOther = 2;
    }

    /// <summary>
    /// UI窗体透明度类型
    /// </summary>
    public class UIFormLucenyType
    {
        //完全透明，不能穿透
        public const int Lucency = 0;
        //半透明，不能穿透
        public const int Translucence = 1;
        //低透明度，不能穿透
        public const int ImPenetrable = 2;
        //可以穿透
        public const int Pentrate = 3;
    }
    ...
    {
        /* 路径常量 */
        public const string SYS_PATH_CANVAS = "UIRoot";
