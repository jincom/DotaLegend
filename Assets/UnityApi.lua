...
Tweener.fullPosition = nil 
--*
--[Comment]
--overrides:
--*
--Tweener ChangeStartValue(Object newStartValue,Single newDuration)
--
--params:
...
function Tweener:ChangeStartValue() end 

--[Comment]
--overrides:
--*
--Tweener ChangeEndValue(Object newEndValue,Single newDuration,Boolean snapStartValue)
--
--params:
...
--*
--Tweener ChangeEndValue(Object newEndValue,Boolean snapStartValue)
--
--params:
--newEndValue:    The new end value
--snapStartValue:    If TRUE the start value will become the current target's value, otherwise it will stay the same
...
--*
--no static method,use ':'
function Tweener:ChangeEndValue() end 

--[Comment]
--overrides:
--*
--Tweener ChangeValues(Object newStartValue,Object newEndValue,Single newDuration)
--
--params:
--newStartValue:    The new start value
--newEndValue:    The new end value
...
--*
--no static method,use ':'
function Tweener:ChangeValues() end 

TweenerCore`3 = {} 
--*
--[Comment]
-- property: Single TweenerCore`3.fullPosition	get	set	
TweenerCore`3.fullPosition = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--no static method,use ':'
function TweenerCore`3:ChangeStartValue() end 
...
--*
--no static method,use ':'
function TweenerCore`3:ChangeEndValue() end 
...
--*
--no static method,use ':'
function TweenerCore`3:ChangeValues() end 

LoopType = {} 

LoopType.Restart = nil;

LoopType.Yoyo = nil;

LoopType.Incremental = nil;
...
PathMode.TopDown2D = nil;

PathMode.Sidescroller2D = nil;

PathType = {} 

PathType.Linear = nil;

PathType.CatmullRom = nil;

RotateMode = {} 

RotateMode.Fast = nil;

RotateMode.FastBeyond360 = nil;

RotateMode.WorldAxisAdd = nil;

RotateMode.LocalAxisAdd = nil;
...
--*
--Void SetBuffer(Int32 nameID,ComputeBuffer value)
--Set a named ComputeBuffer value.
--params:
--nameID:    Property name ID, use Shader.PropertyToID to get it.
--name:    Property name.
...
--*
--[Comment]
-- property: Boolean Graphic.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
Graphic.runInEditMode = nil 
--*
--[Comment]
...
--*
--Void CrossFadeColor(Color targetColor,Single duration,Boolean ignoreTimeScale,Boolean useAlpha,Boolean useRGB)
--*
--no static method,use ':'
...
--*
--[Comment]
-- property: Boolean Image.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
Image.runInEditMode = nil 
--*
--[Comment]
...
--*
--[Comment]
-- property: Boolean RawImage.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
RawImage.runInEditMode = nil 
--*
--[Comment]
...
Sprite.associatedAlphaSplitTexture = nil 
--*
--[Comment]
...
--overrides:
--*
--Sprite Create(Texture2D texture,Rect rect,Vector2 pivot,Single pixelsPerUnit,UInt32 extrude,SpriteMeshType meshType,Vector4 border)
...
--*
--Sprite Create(Texture2D texture,Rect rect,Vector2 pivot,Single pixelsPerUnit,UInt32 extrude,SpriteMeshType meshType)
--*
--Sprite Create(Texture2D texture,Rect rect,Vector2 pivot,Single pixelsPerUnit,UInt32 extrude)
--*
--Sprite Create(Texture2D texture,Rect rect,Vector2 pivot,Single pixelsPerUnit)
--*
...
--*
--no static method,use ':'
function Sprite:OverrideGeometry() end 
...
--Enabled Behaviours are Updated, disabled Behaviours are not.
DirectorPlayer.enabled = nil 
--*
--[Comment]
-- property: Boolean DirectorPlayer.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
DirectorPlayer.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform DirectorPlayer.transform	get	
--The Transform attached to this GameObject.
DirectorPlayer.transform = nil 
--*
--[Comment]
-- property: GameObject DirectorPlayer.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
DirectorPlayer.gameObject = nil 
--*
--[Comment]
-- property: String DirectorPlayer.tag	get	set	
--The tag of this game object.
DirectorPlayer.tag = nil 
--*
--[Comment]
-- property: String DirectorPlayer.name	get	set	
--The name of the object.
DirectorPlayer.name = nil 
--*
--[Comment]
-- property: HideFlags DirectorPlayer.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
DirectorPlayer.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
--Void Play(Playable pStruct)
--Starts playing a Experimental.Director.Playable tree.
--params:
--playable:    The root Experimental.Director.Playable in the tree.

--*
--no static method,use ':'
function DirectorPlayer:Play() end 

--[Comment]
--overrides:
--*
--Void Stop()
--Stop the playback of the Player and Experimental.Director.Playable.
--*
--no static method,use ':'
function DirectorPlayer:Stop() end 
...
--*
--no static method,use ':'
function DirectorPlayer:SetTime() end 
...
--*
--no static method,use ':'
function DirectorPlayer:GetTime() end 
...
--*
--no static method,use ':'
function DirectorPlayer:SetTimeUpdateMode() end 

--[Comment]
--overrides:
--*
--DirectorUpdateMode GetTimeUpdateMode()
--Returns the current Experimental.Director.DirectorUpdateMode.
--*
--no static method,use ':'
function DirectorPlayer:GetTimeUpdateMode() end 
...
--*
--[Comment]
-- property: Single Canvas.normalizedSortingGridSize	get	set	
...
--*
--[Comment]
--consturctor for CanvasGroup overrides:
--*
--CanvasGroup.New()
--*
...
--*
--[Comment]
-- property: Single CanvasGroup.alpha	get	set	
--Set the alpha of the group.
CanvasGroup.alpha = nil 
--*
--[Comment]
-- property: Boolean CanvasGroup.interactable	get	set	
--Is the group interactable (are the elements beneath the group enabled).
CanvasGroup.interactable = nil 
--*
--[Comment]
-- property: Boolean CanvasGroup.blocksRaycasts	get	set	
--Does this group block raycasting (allow collision).
CanvasGroup.blocksRaycasts = nil 
--*
--[Comment]
-- property: Boolean CanvasGroup.ignoreParentGroups	get	set	
--Should the group ignore parent groups?
CanvasGroup.ignoreParentGroups = nil 
--*
--[Comment]
-- property: Transform CanvasGroup.transform	get	
--The Transform attached to this GameObject.
CanvasGroup.transform = nil 
--*
--[Comment]
-- property: GameObject CanvasGroup.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
CanvasGroup.gameObject = nil 
--*
--[Comment]
-- property: String CanvasGroup.tag	get	set	
--The tag of this game object.
CanvasGroup.tag = nil 
--*
--[Comment]
-- property: String CanvasGroup.name	get	set	
--The name of the object.
CanvasGroup.name = nil 
--*
--[Comment]
-- property: HideFlags CanvasGroup.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
...
--overrides:
--*
--Boolean IsRaycastLocationValid(Vector2 sp,Camera eventCamera)
--Returns true if the Group allows raycasts.
--*
--no static method,use ':'
function CanvasGroup:IsRaycastLocationValid() end 

RenderMode = {} 

RenderMode.ScreenSpaceOverlay = nil;

RenderMode.ScreenSpaceCamera = nil;

RenderMode.WorldSpace = nil;
...
--Disabling this lets you skip the GUI layout phase.
Button.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean Button.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
Button.runInEditMode = nil 
--*
--[Comment]
...
--Has the Behaviour had enabled called.
Button.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform Button.transform	get	
--The Transform attached to this GameObject.
Button.transform = nil 
--*
--[Comment]
...
--*
--no static method,use ':'
function Button:OnPointerClick() end 
...
--*
--[Comment]
-- property: Boolean Toggle.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
Toggle.runInEditMode = nil 
--*
--[Comment]
...
ToggleGroup.allowSwitchOff = nil 
--*
--[Comment]
-- property: Boolean ToggleGroup.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
ToggleGroup.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean ToggleGroup.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
ToggleGroup.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean ToggleGroup.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
ToggleGroup.enabled = nil 
--*
--[Comment]
-- property: Boolean ToggleGroup.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
ToggleGroup.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform ToggleGroup.transform	get	
--The Transform attached to this GameObject.
ToggleGroup.transform = nil 
--*
--[Comment]
-- property: GameObject ToggleGroup.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
ToggleGroup.gameObject = nil 
--*
--[Comment]
...
--*
--no static method,use ':'
function ToggleGroup:NotifyToggleOn() end 
...
--params:
--toggle:    Unregister toggle.

--*
--no static method,use ':'
function ToggleGroup:UnregisterToggle() end 
...
--*
--no static method,use ':'
function ToggleGroup:RegisterToggle() end 
...
--Disabling this lets you skip the GUI layout phase.
ScrollRect.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean ScrollRect.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
ScrollRect.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean ScrollRect.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
ScrollRect.enabled = nil 
--*
--[Comment]
-- property: Boolean ScrollRect.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
ScrollRect.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform ScrollRect.transform	get	
--The Transform attached to this GameObject.
ScrollRect.transform = nil 
--*
--[Comment]
-- property: GameObject ScrollRect.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
ScrollRect.gameObject = nil 
--*
--[Comment]
...
--*
--no static method,use ':'
function ScrollRect:Rebuild() end 
...
--*
--no static method,use ':'
function ScrollRect:OnScroll() end 
...
--*
--no static method,use ':'
function ScrollRect:OnInitializePotentialDrag() end 
...
--*
--no static method,use ':'
function ScrollRect:OnBeginDrag() end 
...
--*
--no static method,use ':'
function ScrollRect:OnEndDrag() end 
...
--*
--no static method,use ':'
function ScrollRect:OnDrag() end 
...
--Disabling this lets you skip the GUI layout phase.
Slider.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean Slider.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
Slider.runInEditMode = nil 
--*
--[Comment]
...
--*
--no static method,use ':'
function Slider:OnPointerDown() end 
...
--*
--no static method,use ':'
function Slider:OnInitializePotentialDrag() end 

--[Comment]
--overrides:
--*
--Void SetDirection(Direction direction,Boolean includeRectLayouts)
--*
--no static method,use ':'
function Slider:SetDirection() end 
...
--*
--[Comment]
-- property: Corner GridLayoutGroup.startCorner	get	set	
--Which corner should the first cell be placed in?
GridLayoutGroup.startCorner = nil 
--*
--[Comment]
-- property: Axis GridLayoutGroup.startAxis	get	set	
--Which axis should cells be placed along first?
GridLayoutGroup.startAxis = nil 
--*
--[Comment]
-- property: Vector2 GridLayoutGroup.cellSize	get	set	
--The size to use for each cell in the grid.
GridLayoutGroup.cellSize = nil 
--*
--[Comment]
-- property: Vector2 GridLayoutGroup.spacing	get	set	
--The spacing to use between layout elements in the grid.
GridLayoutGroup.spacing = nil 
--*
--[Comment]
-- property: Constraint GridLayoutGroup.constraint	get	set	
--Which constraint to use for the GridLayoutGroup.
GridLayoutGroup.constraint = nil 
--*
--[Comment]
-- property: Int32 GridLayoutGroup.constraintCount	get	set	
--How many cells there should be along the constrained axis.
GridLayoutGroup.constraintCount = nil 
--*
--[Comment]
-- property: RectOffset GridLayoutGroup.padding	get	set	
--The padding to add around the child layout elements.
GridLayoutGroup.padding = nil 
--*
--[Comment]
-- property: TextAnchor GridLayoutGroup.childAlignment	get	set	
--The alignment to use for the child layout elements in the layout group.
GridLayoutGroup.childAlignment = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.minWidth	get	
--Called by the layout system.
GridLayoutGroup.minWidth = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.preferredWidth	get	
--Called by the layout system.
GridLayoutGroup.preferredWidth = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.flexibleWidth	get	
--Called by the layout system.
GridLayoutGroup.flexibleWidth = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.minHeight	get	
--Called by the layout system.
GridLayoutGroup.minHeight = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.preferredHeight	get	
--Called by the layout system.
GridLayoutGroup.preferredHeight = nil 
--*
--[Comment]
-- property: Single GridLayoutGroup.flexibleHeight	get	
--Called by the layout system.
GridLayoutGroup.flexibleHeight = nil 
--*
--[Comment]
-- property: Int32 GridLayoutGroup.layoutPriority	get	
--Called by the layout system.
GridLayoutGroup.layoutPriority = nil 
--*
--[Comment]
-- property: Boolean GridLayoutGroup.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
GridLayoutGroup.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean GridLayoutGroup.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
GridLayoutGroup.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean GridLayoutGroup.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
GridLayoutGroup.enabled = nil 
--*
--[Comment]
-- property: Boolean GridLayoutGroup.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
GridLayoutGroup.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform GridLayoutGroup.transform	get	
--The Transform attached to this GameObject.
GridLayoutGroup.transform = nil 
--*
--[Comment]
-- property: GameObject GridLayoutGroup.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
GridLayoutGroup.gameObject = nil 
--*
--[Comment]
-- property: String GridLayoutGroup.tag	get	set	
--The tag of this game object.
GridLayoutGroup.tag = nil 
--*
--[Comment]
-- property: String GridLayoutGroup.name	get	set	
--The name of the object.
GridLayoutGroup.name = nil 
--*
--[Comment]
-- property: HideFlags GridLayoutGroup.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
GridLayoutGroup.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
HorizontalLayoutGroup.spacing = nil 
--*
--[Comment]
...
HorizontalLayoutGroup.childForceExpandWidth = nil 
--*
--[Comment]
...
HorizontalLayoutGroup.childForceExpandHeight = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.childControlWidth	get	set	
--Should the layout group control the widths of the children?
HorizontalLayoutGroup.childControlWidth = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.childControlHeight	get	set	
--Should the layout group control the heights of the children?
HorizontalLayoutGroup.childControlHeight = nil 
--*
--[Comment]
-- property: RectOffset HorizontalLayoutGroup.padding	get	set	
--The padding to add around the child layout elements.
HorizontalLayoutGroup.padding = nil 
--*
--[Comment]
-- property: TextAnchor HorizontalLayoutGroup.childAlignment	get	set	
--The alignment to use for the child layout elements in the layout group.
HorizontalLayoutGroup.childAlignment = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.minWidth	get	
--Called by the layout system.
HorizontalLayoutGroup.minWidth = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.preferredWidth	get	
--Called by the layout system.
HorizontalLayoutGroup.preferredWidth = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.flexibleWidth	get	
--Called by the layout system.
HorizontalLayoutGroup.flexibleWidth = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.minHeight	get	
--Called by the layout system.
HorizontalLayoutGroup.minHeight = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.preferredHeight	get	
--Called by the layout system.
HorizontalLayoutGroup.preferredHeight = nil 
--*
--[Comment]
-- property: Single HorizontalLayoutGroup.flexibleHeight	get	
--Called by the layout system.
HorizontalLayoutGroup.flexibleHeight = nil 
--*
--[Comment]
-- property: Int32 HorizontalLayoutGroup.layoutPriority	get	
--Called by the layout system.
HorizontalLayoutGroup.layoutPriority = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
HorizontalLayoutGroup.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
HorizontalLayoutGroup.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
HorizontalLayoutGroup.enabled = nil 
--*
--[Comment]
-- property: Boolean HorizontalLayoutGroup.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
HorizontalLayoutGroup.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform HorizontalLayoutGroup.transform	get	
--The Transform attached to this GameObject.
HorizontalLayoutGroup.transform = nil 
--*
--[Comment]
-- property: GameObject HorizontalLayoutGroup.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
HorizontalLayoutGroup.gameObject = nil 
--*
--[Comment]
-- property: String HorizontalLayoutGroup.tag	get	set	
--The tag of this game object.
HorizontalLayoutGroup.tag = nil 
--*
--[Comment]
-- property: String HorizontalLayoutGroup.name	get	set	
--The name of the object.
HorizontalLayoutGroup.name = nil 
--*
--[Comment]
-- property: HideFlags HorizontalLayoutGroup.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
HorizontalLayoutGroup.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--[Comment]
-- property: EventSystem EventSystem.current	get	set	
--Return the current EventSystem.
EventSystem.current = nil 
--*
--[Comment]
-- property: Boolean EventSystem.sendNavigationEvents	get	set	
--Should the EventSystem allow navigation events (move  submit  cancel).
EventSystem.sendNavigationEvents = nil 
--*
--[Comment]
-- property: Int32 EventSystem.pixelDragThreshold	get	set	
--The soft area for dragging in pixels.
EventSystem.pixelDragThreshold = nil 
--*
--[Comment]
-- property: BaseInputModule EventSystem.currentInputModule	get	
--The currently active EventSystems.BaseInputModule.
EventSystem.currentInputModule = nil 
--*
--[Comment]
-- property: GameObject EventSystem.firstSelectedGameObject	get	set	
--The GameObject that was selected first.
EventSystem.firstSelectedGameObject = nil 
--*
--[Comment]
-- property: GameObject EventSystem.currentSelectedGameObject	get	
--The GameObject currently considered active by the EventSystem.
EventSystem.currentSelectedGameObject = nil 
--*
--[Comment]
-- property: Boolean EventSystem.alreadySelecting	get	
--Returns true if the EventSystem is already in a SetSelectedGameObject.
EventSystem.alreadySelecting = nil 
--*
--[Comment]
-- property: Boolean EventSystem.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
EventSystem.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean EventSystem.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
EventSystem.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean EventSystem.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
EventSystem.enabled = nil 
--*
--[Comment]
-- property: Boolean EventSystem.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
EventSystem.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform EventSystem.transform	get	
--The Transform attached to this GameObject.
EventSystem.transform = nil 
--*
--[Comment]
-- property: GameObject EventSystem.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
EventSystem.gameObject = nil 
--*
--[Comment]
-- property: String EventSystem.tag	get	set	
--The tag of this game object.
EventSystem.tag = nil 
--*
--[Comment]
-- property: String EventSystem.name	get	set	
--The name of the object.
EventSystem.name = nil 
--*
--[Comment]
-- property: HideFlags EventSystem.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
EventSystem.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--no static method,use ':'
function EventSystem:SetSelectedGameObject() end 

--[Comment]
--overrides:
--*
--Void RaycastAll(PointerEventData eventData,List`1 raycastResults)
--*
--no static method,use ':'
function EventSystem:RaycastAll() end 
...
--*
--Boolean IsPointerOverGameObject(Int32 pointerId)
--Is the pointer with the given ID over an EventSystem object?
--params:
--pointerId:    Pointer (touch / mouse) ID.
...
--*
--[Comment]
--consturctor for GUILayer overrides:
--*
--GUILayer.New()
--*

function GUILayer.New() end
--*
--[Comment]
-- property: Boolean GUILayer.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
GUILayer.enabled = nil 
--*
--[Comment]
-- property: Boolean GUILayer.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
GUILayer.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform GUILayer.transform	get	
--The Transform attached to this GameObject.
GUILayer.transform = nil 
--*
--[Comment]
-- property: GameObject GUILayer.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
GUILayer.gameObject = nil 
--*
--[Comment]
-- property: String GUILayer.tag	get	set	
--The tag of this game object.
GUILayer.tag = nil 
--*
--[Comment]
-- property: String GUILayer.name	get	set	
--The name of the object.
GUILayer.name = nil 
--*
--[Comment]
-- property: HideFlags GUILayer.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
...
--*
--no static method,use ':'
function GUILayer:HitTest() end 

CanvasScaler = {} 
--*
--[Comment]
-- property: ScaleMode CanvasScaler.uiScaleMode	get	set	
--Determines how UI elements in the Canvas are scaled.
CanvasScaler.uiScaleMode = nil 
--*
--[Comment]
-- property: Single CanvasScaler.referencePixelsPerUnit	get	set	
--If a sprite has this 'Pixels Per Unit' setting, then one pixel in the sprite will cover one unit in the UI.
CanvasScaler.referencePixelsPerUnit = nil 
--*
--[Comment]
-- property: Single CanvasScaler.scaleFactor	get	set	
--Scales all UI elements in the Canvas by this factor.
CanvasScaler.scaleFactor = nil 
--*
--[Comment]
-- property: Vector2 CanvasScaler.referenceResolution	get	set	
--The resolution the UI layout is designed for.
CanvasScaler.referenceResolution = nil 
--*
--[Comment]
-- property: ScreenMatchMode CanvasScaler.screenMatchMode	get	set	
--A mode used to scale the canvas area if the aspect ratio of the current resolution doesn't fit the reference resolution.
CanvasScaler.screenMatchMode = nil 
--*
--[Comment]
-- property: Single CanvasScaler.matchWidthOrHeight	get	set	
--Setting to scale the Canvas to match the width or height of the reference resolution, or a combination.
CanvasScaler.matchWidthOrHeight = nil 
--*
--[Comment]
-- property: Unit CanvasScaler.physicalUnit	get	set	
--The physical unit to specify positions and sizes in.
CanvasScaler.physicalUnit = nil 
--*
--[Comment]
-- property: Single CanvasScaler.fallbackScreenDPI	get	set	
--The DPI to assume if the screen DPI is not known.
CanvasScaler.fallbackScreenDPI = nil 
--*
--[Comment]
-- property: Single CanvasScaler.defaultSpriteDPI	get	set	
...
CanvasScaler.defaultSpriteDPI = nil 
--*
--[Comment]
-- property: Single CanvasScaler.dynamicPixelsPerUnit	get	set	
--The amount of pixels per unit to use for dynamically created bitmaps in the UI, such as Text.
CanvasScaler.dynamicPixelsPerUnit = nil 
--*
--[Comment]
-- property: Boolean CanvasScaler.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
CanvasScaler.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean CanvasScaler.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
CanvasScaler.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean CanvasScaler.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
CanvasScaler.enabled = nil 
--*
--[Comment]
-- property: Boolean CanvasScaler.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
CanvasScaler.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform CanvasScaler.transform	get	
--The Transform attached to this GameObject.
CanvasScaler.transform = nil 
--*
--[Comment]
-- property: GameObject CanvasScaler.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
CanvasScaler.gameObject = nil 
--*
--[Comment]
-- property: String CanvasScaler.tag	get	set	
--The tag of this game object.
CanvasScaler.tag = nil 
--*
--[Comment]
-- property: String CanvasScaler.name	get	set	
--The name of the object.
CanvasScaler.name = nil 
--*
--[Comment]
-- property: HideFlags CanvasScaler.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
CanvasScaler.hideFlags = nil 
--*
StandaloneInputModule = {} 
--*
--[Comment]
-- property: Boolean StandaloneInputModule.forceModuleActive	get	set	
--Force this module to be active.
StandaloneInputModule.forceModuleActive = nil 
--*
--[Comment]
-- property: Single StandaloneInputModule.inputActionsPerSecond	get	set	
--Number of keyboard / controller inputs allowed per second.
StandaloneInputModule.inputActionsPerSecond = nil 
--*
--[Comment]
-- property: Single StandaloneInputModule.repeatDelay	get	set	
--Delay in seconds before the input actions per second repeat rate takes effect.
StandaloneInputModule.repeatDelay = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.horizontalAxis	get	set	
--Input manager name for the horizontal axis button.
StandaloneInputModule.horizontalAxis = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.verticalAxis	get	set	
--Input manager name for the vertical axis.
StandaloneInputModule.verticalAxis = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.submitButton	get	set	
--Maximum number of input events handled per second.
StandaloneInputModule.submitButton = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.cancelButton	get	set	
--Input manager name for the 'cancel' button.
StandaloneInputModule.cancelButton = nil 
--*
--[Comment]
-- property: BaseInput StandaloneInputModule.input	get	
--The current BaseInput being used by the input module.
StandaloneInputModule.input = nil 
--*
--[Comment]
-- property: Boolean StandaloneInputModule.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
StandaloneInputModule.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean StandaloneInputModule.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
StandaloneInputModule.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean StandaloneInputModule.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
StandaloneInputModule.enabled = nil 
--*
--[Comment]
-- property: Boolean StandaloneInputModule.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
StandaloneInputModule.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform StandaloneInputModule.transform	get	
--The Transform attached to this GameObject.
StandaloneInputModule.transform = nil 
--*
--[Comment]
-- property: GameObject StandaloneInputModule.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
StandaloneInputModule.gameObject = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.tag	get	set	
--The tag of this game object.
StandaloneInputModule.tag = nil 
--*
--[Comment]
-- property: String StandaloneInputModule.name	get	set	
--The name of the object.
StandaloneInputModule.name = nil 
--*
--[Comment]
-- property: HideFlags StandaloneInputModule.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
StandaloneInputModule.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
GraphicRaycaster.sortOrderPriority = nil 
--*
--[Comment]
-- property: Int32 GraphicRaycaster.renderOrderPriority	get	
GraphicRaycaster.renderOrderPriority = nil 
--*
--[Comment]
...
ScaleMode.ConstantPixelSize = nil;

ScaleMode.ScaleWithScreenSize = nil;

ScaleMode.ConstantPhysicalSize = nil;

ScreenMatchMode = {} 

ScreenMatchMode.MatchWidthOrHeight = nil;

ScreenMatchMode.Expand = nil;

ScreenMatchMode.Shrink = nil;

PointerEventData = {} 
--*
--[Comment]
--consturctor for PointerEventData overrides:
--*
--PointerEventData.New(EventSystem eventSystem)
--*

function PointerEventData.New() end
--*
--[Comment]
-- property: GameObject PointerEventData.pointerEnter	get	set	
--The object that received 'OnPointerEnter'.
PointerEventData.pointerEnter = nil 
--*
--[Comment]
-- property: GameObject PointerEventData.lastPress	get	set	
--The GameObject for the last press event.
PointerEventData.lastPress = nil 
--*
--[Comment]
-- property: GameObject PointerEventData.rawPointerPress	get	set	
--The object that the press happened on even if it can not handle the press event.
PointerEventData.rawPointerPress = nil 
--*
--[Comment]
-- property: GameObject PointerEventData.pointerDrag	get	set	
--The object that is receiving 'OnDrag'.
PointerEventData.pointerDrag = nil 
--*
--[Comment]
-- property: RaycastResult PointerEventData.pointerCurrentRaycast	get	set	
--RaycastResult associated with the current event.
PointerEventData.pointerCurrentRaycast = nil 
--*
--[Comment]
-- property: RaycastResult PointerEventData.pointerPressRaycast	get	set	
--RaycastResult associated with the pointer press.
PointerEventData.pointerPressRaycast = nil 
--*
--[Comment]
-- property: Boolean PointerEventData.eligibleForClick	get	set	
PointerEventData.eligibleForClick = nil 
--*
--[Comment]
-- property: Int32 PointerEventData.pointerId	get	set	
--Id of the pointer (touch id).
PointerEventData.pointerId = nil 
--*
--[Comment]
-- property: Vector2 PointerEventData.position	get	set	
--Current pointer position.
PointerEventData.position = nil 
--*
--[Comment]
-- property: Vector2 PointerEventData.delta	get	set	
--Pointer delta since last update.
PointerEventData.delta = nil 
--*
--[Comment]
-- property: Vector2 PointerEventData.pressPosition	get	set	
--Position of the press.
PointerEventData.pressPosition = nil 
--*
--[Comment]
-- property: Single PointerEventData.clickTime	get	set	
--The last time a click event was sent.
PointerEventData.clickTime = nil 
--*
--[Comment]
-- property: Int32 PointerEventData.clickCount	get	set	
--Number of clicks in a row.
PointerEventData.clickCount = nil 
--*
--[Comment]
-- property: Vector2 PointerEventData.scrollDelta	get	set	
--The amount of scroll since the last update.
PointerEventData.scrollDelta = nil 
--*
--[Comment]
-- property: Boolean PointerEventData.useDragThreshold	get	set	
--Should a drag threshold be used?
PointerEventData.useDragThreshold = nil 
--*
--[Comment]
-- property: Boolean PointerEventData.dragging	get	set	
--Is a drag operation currently occuring.
PointerEventData.dragging = nil 
--*
--[Comment]
-- property: InputButton PointerEventData.button	get	set	
--The EventSystems.PointerEventData.InputButton for this event.
PointerEventData.button = nil 
--*
--[Comment]
-- property: Camera PointerEventData.enterEventCamera	get	
--The camera associated with the last OnPointerEnter event.
PointerEventData.enterEventCamera = nil 
--*
--[Comment]
-- property: Camera PointerEventData.pressEventCamera	get	
--The camera associated with the last OnPointerPress event.
PointerEventData.pressEventCamera = nil 
--*
--[Comment]
-- property: GameObject PointerEventData.pointerPress	get	set	
--The GameObject that received the OnPointerDown.
PointerEventData.pointerPress = nil 
--*
--[Comment]
-- property: BaseInputModule PointerEventData.currentInputModule	get	
--A reference to the BaseInputModule that sent this event.
PointerEventData.currentInputModule = nil 
--*
--[Comment]
-- property: GameObject PointerEventData.selectedObject	get	set	
--The object currently considered selected by the EventSystem.
PointerEventData.selectedObject = nil 
--*
--[Comment]
-- property: Boolean PointerEventData.used	get	
--Is the event used?
PointerEventData.used = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--[Comment]
--consturctor for AxisEventData overrides:
--*
--AxisEventData.New(EventSystem eventSystem)
--*

function AxisEventData.New() end
--*
--[Comment]
-- property: Vector2 AxisEventData.moveVector	get	set	
--Raw input vector associated with this event.
AxisEventData.moveVector = nil 
--*
--[Comment]
-- property: MoveDirection AxisEventData.moveDir	get	set	
--MoveDirection for this event.
AxisEventData.moveDir = nil 
--*
--[Comment]
-- property: BaseInputModule AxisEventData.currentInputModule	get	
--A reference to the BaseInputModule that sent this event.
AxisEventData.currentInputModule = nil 
--*
--[Comment]
-- property: GameObject AxisEventData.selectedObject	get	set	
--The object currently considered selected by the EventSystem.
AxisEventData.selectedObject = nil 
--*
--[Comment]
-- property: Boolean AxisEventData.used	get	
--Is the event used?
AxisEventData.used = nil 
--*
BaseEventData = {} 
--*
--[Comment]
--consturctor for BaseEventData overrides:
--*
--BaseEventData.New(EventSystem eventSystem)
--Construct a BaseEventData tied to the passed EventSystem.
--*

function BaseEventData.New() end
--*
--[Comment]
-- property: BaseInputModule BaseEventData.currentInputModule	get	
--A reference to the BaseInputModule that sent this event.
BaseEventData.currentInputModule = nil 
--*
--[Comment]
-- property: GameObject BaseEventData.selectedObject	get	set	
--The object currently considered selected by the EventSystem.
BaseEventData.selectedObject = nil 
--*
--[Comment]
-- property: Boolean BaseEventData.used	get	
--Is the event used?
BaseEventData.used = nil 
--*
Util = {} 
--*
--[Comment]
...
--*
--Void SetParent(GameObject child,Transform parent)
--*
--Void SetParent(Transform child,GameObject parent)
--*
--Void SetParent(Transform child,Transform parent)
--*
--static method,use '.'
function Util.SetParent() end 

--[Comment]
--overrides:
--*
--Transform GetParent(GameObject target)
--*
--static method,use '.'
function Util.GetParent() end 
...
--overrides:
--*
--GameObject[] Childs(GameObject go)
--*
--GameObject[] Childs(Transform tran)
--*
--static method,use '.'
function Util.Childs() end 
...
--overrides:
--*
--Void SetLocalPosition(GameObject target,Vector3 pos)
--*
--Void SetLocalPosition(GameObject target,Single x,Single y,Single z)
--*
--static method,use '.'
function Util.SetLocalPosition() end 

--[Comment]
--overrides:
--*
--Vector3 GetLocalPosition(GameObject target)
--*
--static method,use '.'
function Util.GetLocalPosition() end 

--[Comment]
--overrides:
--*
--Void SetAnchorsPos(GameObject target,Vector2 pos)
--*
--static method,use '.'
function Util.SetAnchorsPos() end 

--[Comment]
--overrides:
--*
--Vector2 GetAnchorsPos(GameObject target)
--*
--static method,use '.'
function Util.GetAnchorsPos() end 
...
--overrides:
--*
--Void SetMaskableInChild(GameObject root,Boolean maskable)
--*
--static method,use '.'
function Util.SetMaskableInChild() end 

--[Comment]
--overrides:
--*
--Void SetMaskable(GameObject target,Boolean maskable)
--*
--static method,use '.'
function Util.SetMaskable() end 
...
--*
--static method,use '.'
function LuaHelper.GetUIManager() end 
...
--overrides:
--*
--Void OnCallLuaFunc(Byte[] data,LuaFunction func)
--*
--static method,use '.'
...
--*
--[Comment]
-- property: LuaState LuaBehaviour.MAIN_STATE	get	
LuaBehaviour.MAIN_STATE = nil 
--*
--[Comment]
-- property: LuaTable LuaBehaviour.peer	get	
LuaBehaviour.peer = nil 
--*
--[Comment]
-- property: LuaTable LuaBehaviour.LuaComponent	get	
LuaBehaviour.LuaComponent = nil 
--*
--[Comment]
...
--overrides:
--*
--LuaBehaviour Add(GameObject go,LuaTable luaComponent)
--*
--static method,use '.'
function LuaBehaviour.Add() end 

--[Comment]
--overrides:
--*
--LuaBehaviour Get(GameObject go,LuaTable luaComponent)
--*
--static method,use '.'
function LuaBehaviour.Get() end 
...
--*
--[Comment]
-- property: Boolean GameManager.PermitUpdate	get	set	
GameManager.PermitUpdate = nil 
--*
--[Comment]
...
--*
--[Comment]
-- property: LuaState LuaManager.MainState	get	
LuaManager.MainState = nil 
--*
--[Comment]
...
--*
--no static method,use ':'
function LuaManager:Require() end 
...
--overrides:
--*
--LuaTable GetLuaTable(String tableName)
--*
--no static method,use ':'
function LuaManager:GetLuaTable() end 

--[Comment]
--overrides:
--*
--LuaFunction GetLuaFunction(String funcname)
--*
--no static method,use ':'
function LuaManager:GetLuaFunction() end 
...
--overrides:
--*
--Void LoadSprite(String abName,String assetName,Action`1 func)
--*
--Void LoadSprite(String abName,String[] assetNames,Action`1 func)
--*
--Void LoadSprite(String abName,String assetNames,LuaFunction func)
--*
--Void LoadSprite(String abName,String[] assetNames,LuaFunction func)
--*
--no static method,use ':'
function ResourceManager:LoadSprite() end 
...
--*
--[Comment]
--consturctor for UIManager overrides:
--*
--UIManager.New()
--*
...
--*
--[Comment]
-- property: Boolean UIManager.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
UIManager.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean UIManager.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
UIManager.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean UIManager.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
UIManager.enabled = nil 
--*
--[Comment]
-- property: Boolean UIManager.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
UIManager.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform UIManager.transform	get	
--The Transform attached to this GameObject.
UIManager.transform = nil 
--*
--[Comment]
-- property: GameObject UIManager.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
UIManager.gameObject = nil 
--*
--[Comment]
-- property: String UIManager.tag	get	set	
--The tag of this game object.
UIManager.tag = nil 
--*
--[Comment]
-- property: String UIManager.name	get	set	
--The name of the object.
UIManager.name = nil 
--*
--[Comment]
-- property: HideFlags UIManager.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
UIManager.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--no static method,use ':'
function UIManager:Awake() end 

--[Comment]
--overrides:
--*
--Void ShowUIForms(String uiFormName)
--*
--Void ShowUIForms(String uiFormName,Boolean isLuaForm)
--*
--Void ShowUIForms(String uiFormName,Boolean isLuaForm,Boolean loadFromAB)
--*
--no static method,use ':'
function UIManager:ShowUIForms() end 

--[Comment]
--overrides:
--*
--Void CloseUIForms(String uiFormName)
--*
--no static method,use ':'
function UIManager:CloseUIForms() end 

--[Comment]
--overrides:
--*
--Int32 ShowALLUIFormCount()
--*
--no static method,use ':'
function UIManager:ShowALLUIFormCount() end 

--[Comment]
--overrides:
--*
--Int32 ShowCurrentUIFormsCount()
--*
--no static method,use ':'
function UIManager:ShowCurrentUIFormsCount() end 

--[Comment]
--overrides:
--*
--Int32 ShowCurrentStackUIFormsCount()
--*
--no static method,use ':'
function UIManager:ShowCurrentStackUIFormsCount() end 

BaseUIForm = {} 
--*
--[Comment]
--consturctor for BaseUIForm overrides:
--*
--BaseUIForm.New()
--*

function BaseUIForm.New() end
--*
--[Comment]
-- property: UIType BaseUIForm.CurrentUIType	get	set	
BaseUIForm.CurrentUIType = nil 
--*
--[Comment]
-- property: Boolean BaseUIForm.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
BaseUIForm.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean BaseUIForm.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
BaseUIForm.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean BaseUIForm.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
BaseUIForm.enabled = nil 
--*
--[Comment]
-- property: Boolean BaseUIForm.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
BaseUIForm.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform BaseUIForm.transform	get	
--The Transform attached to this GameObject.
BaseUIForm.transform = nil 
--*
--[Comment]
-- property: GameObject BaseUIForm.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
BaseUIForm.gameObject = nil 
--*
--[Comment]
-- property: String BaseUIForm.tag	get	set	
--The tag of this game object.
BaseUIForm.tag = nil 
--*
--[Comment]
-- property: String BaseUIForm.name	get	set	
--The name of the object.
BaseUIForm.name = nil 
--*
--[Comment]
-- property: HideFlags BaseUIForm.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
BaseUIForm.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--no static method,use ':'
function BaseUIForm:OnInitialize() end 
...
--*
--no static method,use ':'
function BaseUIForm:Display() end 
...
--*
--no static method,use ':'
function BaseUIForm:Hiding() end 
...
--*
--no static method,use ':'
function BaseUIForm:Redisplay() end 
...
--*
--no static method,use ':'
function BaseUIForm:Freeze() end 

--[Comment]
--overrides:
--*
--Void OpenUIForm(String uiFormName)
--*
--Void OpenUIForm(String uiFormName,Boolean isLuaForm)
--*
--Void OpenUIForm(String uiFormName,Boolean isLuaForm,Boolean loadFromAB)
--*
--no static method,use ':'
function BaseUIForm:OpenUIForm() end 
...
--*
--no static method,use ':'
function BaseUIForm:CloseUIForm() end 

--[Comment]
--overrides:
--*
--Void ReceiveMessage(String messagType,DelMessageDelivery handler)
--*
--no static method,use ':'
function BaseUIForm:ReceiveMessage() end 
...
--*
--no static method,use ':'
function BaseUIForm:Show() end 

LuaUIForm = {} 
--*
--[Comment]
-- property: UIType LuaUIForm.CurrentUIType	get	set	
LuaUIForm.CurrentUIType = nil 
--*
--[Comment]
-- property: Boolean LuaUIForm.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
LuaUIForm.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean LuaUIForm.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
LuaUIForm.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean LuaUIForm.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
LuaUIForm.enabled = nil 
--*
--[Comment]
-- property: Boolean LuaUIForm.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
LuaUIForm.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform LuaUIForm.transform	get	
--The Transform attached to this GameObject.
LuaUIForm.transform = nil 
--*
--[Comment]
-- property: GameObject LuaUIForm.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
LuaUIForm.gameObject = nil 
--*
--[Comment]
-- property: String LuaUIForm.tag	get	set	
--The tag of this game object.
LuaUIForm.tag = nil 
--*
--[Comment]
-- property: String LuaUIForm.name	get	set	
--The name of the object.
LuaUIForm.name = nil 
--*
--[Comment]
-- property: HideFlags LuaUIForm.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
LuaUIForm.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
...
--*
--no static method,use ':'
function LuaUIForm:OnInitialize() end 
...
--*
--no static method,use ':'
function LuaUIForm:Display() end 
...
--*
--no static method,use ':'
function LuaUIForm:Redisplay() end 
...
--*
--no static method,use ':'
function LuaUIForm:Freeze() end 

--[Comment]
--overrides:
--*
--Void CallLuaMethod(String funcname,Object[] objects)
--*
--no static method,use ':'
function LuaUIForm:CallLuaMethod() end 
...
--*
--no static method,use ':'
function LuaUIForm:OnMessage() end 

--[Comment]
--overrides:
--*
--Void AddClickListener(GameObject go,LuaFunction func)
--*
--no static method,use ':'
function LuaUIForm:AddClickListener() end 

--[Comment]
--overrides:
--*
--Void RemoveClickListener(GameObject go)
--*
--no static method,use ':'
function LuaUIForm:RemoveClickListener() end 

UIType = {} 
--*
--[Comment]
--consturctor for UIType overrides:
--*
--UIType.New()
--*

function UIType.New() end
--*
UIEventListener = {} 
--*
--[Comment]
...
--*
--[Comment]
-- property: LuaTable UIEventListener.self	get	set	
UIEventListener.self = nil 
--*
--[Comment]
-- property: Boolean UIEventListener.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
UIEventListener.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean UIEventListener.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
UIEventListener.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean UIEventListener.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
UIEventListener.enabled = nil 
--*
--[Comment]
-- property: Boolean UIEventListener.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
UIEventListener.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform UIEventListener.transform	get	
--The Transform attached to this GameObject.
UIEventListener.transform = nil 
--*
--[Comment]
-- property: GameObject UIEventListener.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
UIEventListener.gameObject = nil 
--*
--[Comment]
-- property: String UIEventListener.tag	get	set	
--The tag of this game object.
UIEventListener.tag = nil 
--*
--[Comment]
-- property: String UIEventListener.name	get	set	
--The name of the object.
UIEventListener.name = nil 
--*
--[Comment]
-- property: HideFlags UIEventListener.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
UIEventListener.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
--Void AddButtonClick(GameObject go,LuaFunction func)
--*
--no static method,use ':'
function UIEventListener:AddButtonClick() end 

--[Comment]
--overrides:
--*
--Void RemoveButtonClick(GameObject go)
--*
--no static method,use ':'
function UIEventListener:RemoveButtonClick() end 

--[Comment]
--overrides:
--*
--Void AddToggleChange(GameObject go,LuaFunction func)
--*
--no static method,use ':'
function UIEventListener:AddToggleChange() end 

--[Comment]
--overrides:
--*
--Void RemoveToggleChange(GameObject go)
--*
--no static method,use ':'
function UIEventListener:RemoveToggleChange() end 

EventTrigger = {} 
--*
--[Comment]
--consturctor for EventTrigger overrides:
--*
--EventTrigger.New()
--*

function EventTrigger.New() end
--*
--[Comment]
-- property: Boolean EventTrigger.IsPassEvent	get	set	
EventTrigger.IsPassEvent = nil 
--*
--[Comment]
-- property: Boolean EventTrigger.useGUILayout	get	set	
--Disabling this lets you skip the GUI layout phase.
EventTrigger.useGUILayout = nil 
--*
--[Comment]
-- property: Boolean EventTrigger.runInEditMode	get	set	
--Allow a specific instance of a MonoBehaviour to run in edit mode (only available in the editor).
EventTrigger.runInEditMode = nil 
--*
--[Comment]
-- property: Boolean EventTrigger.enabled	get	set	
--Enabled Behaviours are Updated, disabled Behaviours are not.
EventTrigger.enabled = nil 
--*
--[Comment]
-- property: Boolean EventTrigger.isActiveAndEnabled	get	
--Has the Behaviour had enabled called.
EventTrigger.isActiveAndEnabled = nil 
--*
--[Comment]
-- property: Transform EventTrigger.transform	get	
--The Transform attached to this GameObject.
EventTrigger.transform = nil 
--*
--[Comment]
-- property: GameObject EventTrigger.gameObject	get	
--The game object this component is attached to. A component is always attached to a game object.
EventTrigger.gameObject = nil 
--*
--[Comment]
-- property: String EventTrigger.tag	get	set	
--The tag of this game object.
EventTrigger.tag = nil 
--*
--[Comment]
-- property: String EventTrigger.name	get	set	
--The name of the object.
EventTrigger.name = nil 
--*
--[Comment]
-- property: HideFlags EventTrigger.hideFlags	get	set	
--Should the object be hidden, saved with the scene or modifiable by the user?
EventTrigger.hideFlags = nil 
--*
--[Comment]
--overrides:
--*
--Void add_onEnter(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onEnter() end 

--[Comment]
--overrides:
--*
--Void remove_onEnter(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onEnter() end 

--[Comment]
--overrides:
--*
--Void add_onExit(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onExit() end 

--[Comment]
--overrides:
--*
--Void remove_onExit(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onExit() end 

--[Comment]
--overrides:
--*
--Void add_onDown(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onDown() end 

--[Comment]
--overrides:
--*
--Void remove_onDown(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onDown() end 

--[Comment]
--overrides:
--*
--Void add_onUp(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onUp() end 

--[Comment]
--overrides:
--*
--Void remove_onUp(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onUp() end 

--[Comment]
--overrides:
--*
--Void add_onClick(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onClick() end 

--[Comment]
--overrides:
--*
--Void remove_onClick(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onClick() end 

--[Comment]
--overrides:
--*
--Void add_onInitializePotentialDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onInitializePotentialDrag() end 

--[Comment]
--overrides:
--*
--Void remove_onInitializePotentialDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onInitializePotentialDrag() end 

--[Comment]
--overrides:
--*
--Void add_onBeginDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onBeginDrag() end 

--[Comment]
--overrides:
--*
--Void remove_onBeginDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onBeginDrag() end 

--[Comment]
--overrides:
--*
--Void add_onDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onDrag() end 

--[Comment]
--overrides:
--*
--Void remove_onDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onDrag() end 

--[Comment]
--overrides:
--*
--Void add_onEndDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onEndDrag() end 

--[Comment]
--overrides:
--*
--Void remove_onEndDrag(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onEndDrag() end 

--[Comment]
--overrides:
--*
--Void add_onDrop(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onDrop() end 

--[Comment]
--overrides:
--*
--Void remove_onDrop(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onDrop() end 

--[Comment]
--overrides:
--*
--Void add_onScroll(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onScroll() end 

--[Comment]
--overrides:
--*
--Void remove_onScroll(PointerDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onScroll() end 

--[Comment]
--overrides:
--*
--Void add_onSelect(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onSelect() end 

--[Comment]
--overrides:
--*
--Void remove_onSelect(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onSelect() end 

--[Comment]
--overrides:
--*
--Void add_onUpdateSelected(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onUpdateSelected() end 

--[Comment]
--overrides:
--*
--Void remove_onUpdateSelected(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onUpdateSelected() end 

--[Comment]
--overrides:
--*
--Void add_onDeselect(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onDeselect() end 

--[Comment]
--overrides:
--*
--Void remove_onDeselect(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onDeselect() end 

--[Comment]
--overrides:
--*
--Void add_onMove(AxisDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onMove() end 

--[Comment]
--overrides:
--*
--Void remove_onMove(AxisDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onMove() end 

--[Comment]
--overrides:
--*
--Void add_onSubmit(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onSubmit() end 

--[Comment]
--overrides:
--*
--Void remove_onSubmit(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onSubmit() end 

--[Comment]
--overrides:
--*
--Void add_onCancel(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:add_onCancel() end 

--[Comment]
--overrides:
--*
--Void remove_onCancel(BaseDelegate value)
--*
--no static method,use ':'
function EventTrigger:remove_onCancel() end 

--[Comment]
--overrides:
--*
--EventTrigger Get(GameObject go)
--*
--static method,use '.'
function EventTrigger.Get() end 
...
--*
--no static method,use ':'
function EventTrigger:OnBeginDrag() end 
...
--*
--no static method,use ':'
function EventTrigger:OnCancel() end 
...
--*
--no static method,use ':'
function EventTrigger:OnDeselect() end 
...
--*
--no static method,use ':'
function EventTrigger:OnDrag() end 
...
--*
--no static method,use ':'
function EventTrigger:OnDrop() end 
...
--*
--no static method,use ':'
function EventTrigger:OnEndDrag() end 
...
--*
--no static method,use ':'
function EventTrigger:OnInitializePotentialDrag() end 
...
--*
--no static method,use ':'
function EventTrigger:OnMove() end 
...
--*
--no static method,use ':'
function EventTrigger:OnPointerClick() end 
...
--*
--no static method,use ':'
function EventTrigger:OnPointerDown() end 
...
--*
--no static method,use ':'
function EventTrigger:OnPointerEnter() end 
...
--*
--no static method,use ':'
function EventTrigger:OnPointerExit() end 
...
--*
--no static method,use ':'
function EventTrigger:OnPointerUp() end 
...
--*
--no static method,use ':'
function EventTrigger:OnScroll() end 
...
--*
--no static method,use ':'
function EventTrigger:OnSelect() end 
...
--*
--no static method,use ':'
function EventTrigger:OnSubmit() end 
...
--*
--no static method,use ':'
function EventTrigger:OnUpdateSelected() end 
